...
import hr.rokym.springboot.musicdbhibernate.service.AlbumService;
import hr.rokym.springboot.musicdbhibernate.service.ArtistService;
import hr.rokym.springboot.musicdbhibernate.service.SongService;
...
public class SongRestController {
	...
	@PostMapping("/songs-multiple/{albumId}/{artistId}")
